...
public record ModelAsset(Optional<Identifier> parent, Optional<List<ModelElement>> elements, Map<String, String> textures,
    ...
    public static final Codec<ModelAsset> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            SortedMapCodec.of(ModelTransformationMode.CODEC, ModelTransformation.CODEC).optionalFieldOf("display", Map.of()).forGetter(ModelAsset::display),
    ...
    public static class Builder {
        ...
        public Builder transformation(ModelTransformationMode context, ModelTransformation transformation) {
